...
<body>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" align="center">
			<tr>
				<h3 style="text-align:center;">Contact Form Submitted</h3>
				<p>Popularity never tasted so good.</p>
			</tr>
			<tr>
				<td width="200" valign="top">From: <?=$this->first_name;?> <?=$this->last_name;?></td>
			</tr>
			<tr>
				<td width="200" valign="top">Email: <?=$this->email;?></td>
			</tr>
			<tr>
				<td width="200" valign="top">Phone: <?=$this->phone;?></td>
			</tr>
			<tr>
				<td width="200" valign="top">Message: <?=$this->message;?></td>
			</tr>
		</table>
